...
print("\nE0 referans kosuyor...")
lb0,_ = run_cv(X, "E0 mevcut    ")

print("\nN1 (net seri) kosuyor...")
X1 = add_net_series(X)
lb1,_ = run_cv(X1, "N1 net-seri  ")
print(f"   delta: {lb1-lb0:+.5f}")

print("\nN1+N2 (first-passage) kosuyor...")
X2 = add_first_passage(X1)
lb2,_ = run_cv(X2, "N2 +firstpass")
print(f"   delta: {lb2-lb0:+.5f}")

print("\n" + "="*68)
print(f"OZET | E0: {lb0:.5f} | N1: {lb1:.5f} ({lb1-lb0:+.5f}) | N1+N2: {lb2:.5f} ({lb2-lb0:+.5f})")
print("Pozitifse v16 tam pipeline bu ozelliklerle gelir. Ciktiyi yapistir.")
