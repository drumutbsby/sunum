...
print("\nE0 (v16 seti) kosuyor...")
lb0,_ = run_cv(Xb, "E0 v16-set   ")

print("\nP1 (+oran serisi & ivme) kosuyor...")
X1 = add_ratio_series(Xb)
lb1,_ = run_cv(X1, "P1 +oranlar  ")
print(f"   delta: {lb1-lb0:+.5f}")

print("\nP2 (+cok-ufuk fp & projeksiyon) kosuyor...")
X2 = add_fp_multi(X1)
lb2,_ = run_cv(X2, "P2 +cokufuk  ")
print(f"   delta: {lb2-lb0:+.5f}")

print("\nP3 (+etkilesimler) kosuyor...")
X3 = add_fp_inter(X2)
lb3,_ = run_cv(X3, "P3 +etkiles. ")
print(f"   delta: {lb3-lb0:+.5f}")

print("\n"+"="*68)
print(f"OZET | E0: {lb0:.5f} | P1: {lb1-lb0:+.5f} | P2(kum): {lb2-lb0:+.5f} | P3(kum): {lb3-lb0:+.5f}")
print("Pozitif katmanlar v17'ye girer. Ciktiyi oldugu gibi yapistir.")
