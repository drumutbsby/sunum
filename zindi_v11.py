# =====================================================================
# Zindi — Financial Stress Prediction  |  v11 (GELIR RITMI / SEMANTIK)
#
# v10 uzerine SEMANTIK ozellikler (maas dongusu sezgisinin aylik
# olcekteki karsiliklari):
#   S1) "MAAS GELMEDI" bayragi: Monthly Earner + son ay geliri sifir
#   S2) Gelir duzenliligi: aylik gelir toplamlarinin degisim katsayisi
#   S3) Gelirsiz seri: en uzun ve en guncel ardisik sifir-gelir ay sayisi
#   S4) Gelir soku: son ay geliri / 6 aylik medyan gelir
#   S5) Bakiye dusus SERISI: kac aydir ustuste dusuyor + dip ayin konumu
#   S6) Kilit ailelere EGIM: deposit_agents, received_senders,
#       withdraw_agents, deposit/received volume (EDA'nin en korele hamlari)
#   S7) Segment-ici ve kazanc-tipi-ici Z-SKORLAR: "kendi grubuna gore
#       anormal cokus mu?" (HVC %19 vs MVC %12.6 stresli idi)
#
# Parametreler v10 aramasindan GOMULU (arama yok -> hizli kosu ~30-35 dk)
#
# Gecilecek hedef (v10): LogLoss 0.24392 | AUC 0.91063 | LB 0.12033
#
# Colab: !pip install catboost lightgbm -q    (optuna GEREKMEZ)
# =====================================================================
