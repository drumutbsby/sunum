# =====================================================================
# Zindi — Financial Stress Prediction  |  v13 FINAL (KAPANIS KOSUSU)
#
# v12 dersi: MLP blend'de 0.0 agirlik aldi, stack'te katki ~0 ->
# agaclar sinyalin tamamini cekmis. MLP ATILDI (20 dk tasarruf).
# Son guvenilir damla: 10-FOLD CV (her model %90 veriyle egitilir,
# OOF daha puruzsuz) x 5 seed = 100 GBM.
#
# Gecilecek hedef (v12): LogLoss 0.24344 | AUC 0.91096 | LB 0.12095
# Beklenti: +0.0005-0.0015 (kucuk ama gercek)
#
# Colab: !pip install catboost lightgbm -q
# Sure (8 vCPU): ~55-70 dk -> ARKA PLANDA YURUT.
#   Zaman darsa N_FOLDS=5 (v12 esdegeri olur).
# =====================================================================
