# =====================================================================
# Zindi — Financial Stress Prediction  |  v14 ENDGAME (TAM YENIDEN-ARAMA)
#
# v13 pipeline'inin AYNISI, tek fark: LGB+CAT Optuna aramalari yeniden
# acik. Cunku gomulu parametreler v10'un 493-ozellikli setinde bulundu;
# simdi 517 ozellik + 10-fold var -> optimum hafif kaymis olabilir.
#
# BU BIR "ENDGAME" KOSUSU: acele etme, arka planda yurut (~1.5-2 saat).
# Ideal zamanlama: simdi BIR kez + kapanis haftasinda (21-28 Eyl) BIR kez.
#
# Gecilecek hedef (v13): LogLoss 0.24278 | AUC 0.91154 | LB 0.12184
# Beklenti: +0.000 ile +0.002 arasi (garanti yok; CV karsilastir, iyiyse yukle)
#
# Colab: !pip install catboost lightgbm optuna -q
# Zaman darsa: LGB_TRIALS=15, CAT_TRIALS=10, N_FOLDS=5
# =====================================================================
...
print(f"\nSecilen: {chosen}")
print(f">>> v13 FINAL CV | LogLoss: {log_loss(y,oof_f):.5f} | AUC: {roc_auc_score(y,oof_f):.5f} | LB: {lb_score(y,oof_f):.5f}")
print("    (v12 idi: LogLoss 0.24344 | AUC 0.91096 | LB 0.12095  <- gecilecek hedef)")
