# =====================================================================
# Zindi — v15p (PARALEL v15 — cok cekirdekli makineler icin: Dataiku vb.)
#
# v15 ile AYNI matematik/ayni sonuc; tek fark: 100 model sirayla degil
# joblib ile PARALEL egitilir. 32 vCPU'da ~25-45 dk (Colab 8 vCPU'da
# sirali hali ~3-5 saatti).
#
# KULLANIM (Dataiku):
#   - Code env'de lightgbm, catboost kurulu olmali
#   - Train.csv / Test.csv / SampleSubmission.csv calisilan klasorde
#   - N_WORKERS'i makinene gore ayarla (asagida otomatik da secilir)
#
