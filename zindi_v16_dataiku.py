# =====================================================================
# Zindi — v16 DATAIKU (NET AKIS + FIRST-PASSAGE tam pipeline)
#
# Lab-4 kesfi: aylik NET NAKIT AKIS serisi (net_m1..m6) + first-passage
# batma olasiliklari 5-fold/1-seed'de +0.00381 kazandirdi — v10'dan beri
# en buyuk deneysel kazanc. v16 bunlari tam pipeline'a ekler:
# paralel yavas-uzun cekirdek (10-fold x 5 seed x LGB+CAT) + 4 aday.
#
# Gecilecek hedef (v15p): LogLoss 0.24258 | AUC 0.91169 | LB 0.12210
# Beklenti: LB ~0.1255-0.1260 -> public ~0.7255-0.7260 -> sira ~25-26
# Sure (40 vCPU): ~35 dk
# =====================================================================
...
print(f"\nSecilen: {chosen}")
print(f">>> v16 CV | LogLoss: {log_loss(y,oof_f):.5f} | AUC: {roc_auc_score(y,oof_f):.5f} | LB: {lb_score(y,oof_f):.5f}")
print("    (v15p idi: LogLoss 0.24258 | AUC 0.91169 | LB 0.12210  <- gecilecek hedef)")
