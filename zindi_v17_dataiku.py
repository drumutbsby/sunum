# =====================================================================
# Zindi — v17 DATAIKU (P1+P2 katmanlari + zengin sette YENIDEN-ARAMA)
#
# Lab-5: P1 oran serisi (+0.0002) ve P2 cok-ufuk first-passage +
# projeksiyon (+0.0006) girdi; P3 etkilesimler ZARARLI cikti, ELENDI.
# Ek koz: parametreler hala v10'un 493-ozellik setinden; simdi 560+
# ozellik var (fp/net dahil degildi) -> RETUNE=True ile hizli arama
# (LGB 20 + CAT 12 deneme, 3-fold), bulunan yapi parametreleri YAVAS
# cekirdekle (lr 0.005/0.01) tam pipeline'da kosulur.
#
# Gecilecek hedef (v16): LogLoss 0.24057 | AUC 0.91346 | LB 0.12481
# Sure (40 vCPU): RETUNE=True ~1-1.5 saat | RETUNE=False ~35 dk
# =====================================================================
...
RETUNE = True   # False yaparsan v16 parametreleriyle ~35 dk'da biter
...
print(f"\nSecilen: {chosen}")
print(f">>> v17 CV | LogLoss: {log_loss(y,oof_f):.5f} | AUC: {roc_auc_score(y,oof_f):.5f} | LB: {lb_score(y,oof_f):.5f}")
print("    (v16 idi: LogLoss 0.24057 | AUC 0.91346 | LB 0.12481  <- gecilecek hedef)")
