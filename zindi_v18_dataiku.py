# =====================================================================
# Zindi — v18 DATAIKU (RUNWAY + SOK katmanlari, v17 parametreleri gomulu)
#
# Lab-6: Q1 runway (+0.00025) ve Q2 tek-islem soku (kumulatif +0.00031)
# girdi; Q3 alt-sigma fp kazanci sifirladi, ELENDI.
# Parametreler v17 RETUNE sonuclari (LGB 19 yaprak/ff 0.40, CAT depth 8)
# GOMULU -> arama yok. RETUNE=True yaparsan yeniden arar.
#
# Gecilecek hedef (v17): LogLoss 0.24014 | AUC 0.91384 | LB 0.12540
# Sure (40 vCPU): ~50 dk (CAT depth-8 yavas)
# =====================================================================
...
print(f"\nSecilen: {chosen}")
print(f">>> v18 CV | LogLoss: {log_loss(y,oof_f):.5f} | AUC: {roc_auc_score(y,oof_f):.5f} | LB: {lb_score(y,oof_f):.5f}")
print("    (v17 idi: LogLoss 0.24014 | AUC 0.91384 | LB 0.12540  <- gecilecek hedef)")
