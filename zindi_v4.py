# =====================================================================
# Zindi — Financial Stress Prediction  |  v4
# v2 + v3 birlesimi: SEED-AVERAGED LightGBM + SEED-AVERAGED CatBoost
#                    + XGBoost, ince blend (0.05 adim, LB metrigi)
# Yeni ozellikler: "son ay vs gecmis" oranlari (stres onumuzdeki 30 gun
#                  icin oldugundan en yeni ay en kritik sinyal)
# Colab: !pip install catboost xgboost lightgbm -q
# Sure notu: 3seed x 5fold x 2model + 1x5 XGB = 35 model (~10-15 dk).
#            Hizli deneme icin SEEDS=[42,2024] yapabilirsin.
# =====================================================================
...
print(f">>> v4 CV | LogLoss: {log_loss(y,oof_b):.5f} | AUC: {roc_auc_score(y,oof_b):.5f} | LB: {lb_score(y,oof_b):.5f}")
