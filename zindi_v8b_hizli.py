# =====================================================================
# Zindi — Financial Stress Prediction  |  v8b (HIZLI FINAL)
#
# v8'in Optuna aramasi TAMAMLANDI, en iyi parametreler buraya GOMULDU
# (arama tekrari yok -> ~25 dk tasarruf). Sonuc birebir ayni pipeline:
# 3-seed LGB(tuned) + 3-seed CAT + blend + kalibrasyon + guvenlik.
# v8 CV: LogLoss 0.25723 | AUC 0.90271 | LB 0.10385
#
# KULLANIM: Zindi'den GUNCEL Train/Test/SampleSubmission indirilip
# Colab'a yuklendikten sonra calistir. Dosyalar uyumsuzsa kod durur.
#
...
print("\nOptuna parametreleri gomulu kullaniliyor (arama atlandi).")
...
print(f"\nSecilen: {chosen}")
print(f">>> v8b CV | LogLoss: {log_loss(y,oof_f):.5f} | AUC: {roc_auc_score(y,oof_f):.5f} | LB: {lb_score(y,oof_f):.5f}")
print("    (v8 idi: LogLoss 0.25723 | AUC 0.90271 | LB 0.10385  <- ayni cikmali)")
